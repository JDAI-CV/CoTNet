...
class PoolingVisionTransformer(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, stride=1, base_dims=384, depth=2, heads=1,
                 mlp_ratio=(0, 0, 0, 0), num_classes=1000, in_chans=3, distilled=False,
                 attn_drop_rate=.0, drop_rate=.0, drop_path_rate=.0, global_pool='avg'):
