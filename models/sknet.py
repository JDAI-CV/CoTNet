...
@register_model
def skresnet50_zerobn(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNet-50 model.
...
@register_model
def skresnext50_32x4d_zerobn(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNeXt50-32x4d model. This should be equivalent to
    the SKNet-50 model in the Select Kernel Paper
    """
    model_args = dict(
...
@register_model
def skresnext101_32x4d_zerobn(pretrained=False, **kwargs):
    """Constructs a Select Kernel ResNeXt50-32x4d model. This should be equivalent to
    the SKNet-50 model in the Select Kernel Paper
    """
    model_args = dict(
        block=SelectiveKernelBottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=4,
        zero_init_last_bn=True, **kwargs)
    return _create_skresnet('skresnext50_32x4d', pretrained, **model_args)